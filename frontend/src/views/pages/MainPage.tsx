          ...
          <img src={DownArrow} alt="down-arrow" id="down-arrow" />
			...
			<section id="about">
				<div className="flex-container">
					<HeroSection
						...
						body={
							<>
								Visualize and alleviate bias in transaction
								datasets fed into fraud detection AI models.
								Check out our{" "}
								<a href="#handy-guide">
									<span className="highlight">
										{" "}
			...
			<section id="handy-guide">
				<div className="process-container">
					<ProcessStep
						title={
							<>
								<span className="highlight">Upload</span> your
								dataset.
							</>
						}
						stepnum={1}
            ...
            For tailored analysis, select the protected attributes you wish to analyze."
					...
					<ProcessStep
						title={
							<>
								<span className="highlight">View</span> our
								feedback.
							</>
						}
						stepnum={2}
            ...
            behind the scores and gain insights into the metrics."
					...
					<ProcessStep
						title={
							<>
								<span className="highlight">Adjust</span> and
								try again!
							</>
						}
						stepnum={3}
